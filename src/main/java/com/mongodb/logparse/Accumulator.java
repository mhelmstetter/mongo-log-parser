...
public class Accumulator {
	...
	public void reportCsv(String fileName) throws FileNotFoundException {
		...
		for (LogLineAccumulator acc : accumulators.values()) {
			writer.println(acc.toCsvString());
		}

	}

	public void accumulate(File file, String findAndModify, Namespace namespace, Long execTime, Long keysExamined,
			Long docsExamined, Object object) {
		accumulate(file, findAndModify, namespace, execTime, keysExamined, docsExamined, object);
